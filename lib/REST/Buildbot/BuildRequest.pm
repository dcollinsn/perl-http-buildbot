package HTTP::Buildbot::BuildRequest;
...
HTTP::Buildbot::BuildRequest - The great new HTTP::Buildbot::BuildRequest!
...
Perhaps a little code snippet.
    ...
    use HTTP::Buildbot::BuildRequest;

    my $foo = HTTP::Buildbot::BuildRequest->new();
    ...
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc HTTP::Buildbot::BuildRequest
...
1; # End of HTTP::Buildbot::BuildRequest
