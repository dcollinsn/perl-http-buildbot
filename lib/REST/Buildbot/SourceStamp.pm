package HTTP::Buildbot::SourceStamp;
...
HTTP::Buildbot::SourceStamp - The great new HTTP::Buildbot::SourceStamp!
...
Perhaps a little code snippet.
    ...
    use HTTP::Buildbot::SourceStamp;

    my $foo = HTTP::Buildbot::SourceStamp->new();
    ...
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc HTTP::Buildbot::SourceStamp
...
1; # End of HTTP::Buildbot::SourceStamp
