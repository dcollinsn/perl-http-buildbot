...
HTTP::Buildbot::Step - The great new HTTP::Buildbot::Step!
...
Perhaps a little code snippet.
    ...
    use HTTP::Buildbot::Step;

    my $foo = HTTP::Buildbot::Step->new();
    ...
